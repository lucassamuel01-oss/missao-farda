...
const EDITAIS = {
  ...
  "SD PMMG": {
    nome: "SD PMMG",
    subtitulo: "Soldado da Polícia Militar de Minas Gerais (CFSd QPPM)",
    tipo: "Prova Objetiva (Edital DRH/CRS nº 10/2024)",
    duracao: "3h",
    questoes: 50,
    notaAlerta:
      "Língua Portuguesa é 40% da prova (20 de 50 questões). Literatura cobra apenas duas obras específicas.",
    estrategia:
      "Para SD PMMG, o sistema dá frequência máxima a Língua Portuguesa, mantém Direito/Direitos Humanos e RLM constantes e garante presença de Literatura e Inglês para não zerar disciplina.",
    prova: [
      "50 questões objetivas — 100 pontos (2 pontos cada), 3h de prova",
      "Língua Portuguesa e Interpretação de Textos: 20 questões",
      "Literatura: 5 questões",
      "Noções de Língua Inglesa: 5 questões",
      "Noções de Direito e Direitos Humanos: 10 questões",
      "Raciocínio Lógico-Matemático: 10 questões",
      "2ª fase: avaliações psicológicas e exames de saúde",
      "Teste de capacitação física exigido no processo e durante o curso de formação",
    ],
    dicas: [
      "Português decide a prova: 20 das 50 questões. Precisa aparecer com frequência máxima no plano, da primeira à última semana.",
      "Literatura cobra só duas obras — Campo Geral (Guimarães Rosa) e Vidas Secas (Graciliano Ramos). Leia as obras e treine questões sobre elas.",
      "O bloco de Direito é enxuto e literal: artigos indicados da CF/88, LINDB, Declaração Universal e Pacto de San José. Leitura de lei seca rende ponto.",
      "RLM da PMMG mistura lógica proposicional com matemática básica: treine tabelas-verdade, equivalências, porcentagem e regra de três com questões.",
    ],
    pesos: {
      "Língua Portuguesa": 20,
      Literatura: 5,
    ...
    materias: {
      "Língua Portuguesa": [
        "Estudo e interpretação de texto",
        "Tipologia e gêneros textuais",
        "Adequação conceitual e articulação de argumentos",
        "Seleção vocabular",
        "Ortografia oficial",
        "Acentuação gráfica",
      ...
      "Noções de Direito e Direitos Humanos": [
        "CF/88 — Princípios Fundamentais (Título I)",
        "CF/88 — Direitos e Deveres Individuais e Coletivos",
        "CF/88 — Nacionalidade e Direitos Políticos",
        "CF/88 — Administração Pública: Disposições Gerais",
        "CF/88 — Militares dos Estados, do DF e dos Territórios",
        "CF/88 — Poder Judiciário: Tribunais e Juízes Militares e dos Estados",
        "CF/88 — Forças Armadas e Segurança Pública",
        "LINDB — Lei de Introdução às Normas do Direito Brasileiro (Lei 4.657/1942)",
        "Declaração Universal dos Direitos Humanos (1948)",
        "Convenção Americana sobre Direitos Humanos — Pacto de San José da Costa Rica (1969)",
      ],
      "Raciocínio Lógico-Matemático": [
        "Interpretação de figuras planas, mapas, gráficos, tabelas e escalas",
        "Estatística básica: população, amostra, tendência central e dispersão",
        "Porcentagem",
        "Lógica proposicional: tabelas-verdade, equivalências e leis de Morgan",
        "Lógica de argumentação: analogias, inferências, deduções e silogismos",
        "Áreas, volumes e estimativas",
        "Equações de 1º e 2º graus e sistemas lineares",
        "Noções de contagem e probabilidade",
